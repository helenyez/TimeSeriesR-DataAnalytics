...
The first difference transformation of a time series z[t] consists of the differences (changes) between successive observations over time.
...
```
##Quiz Example
1. Install `library(nycflights13)`
     it has a dataset flights
...
Nesting the function within plot (e.g., using plot(stl())) produces a single figure showing the original series xt and the
